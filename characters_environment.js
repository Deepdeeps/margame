...
function game(){
  ...
  console.log("noseX = " + noseX +" ,noseY =  "+ noseY);//c141; This is done because draw() function is called continuously, means game() function will also be called continuously, so we will put consoling of noseX and noseY inside game() function
